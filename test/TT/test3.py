...
def saveDrawMap(KBar1M,filename) :
    ...
    ax.plot_date( Time,FastMA, 'k-' , linewidth=1 ,color='#0000FF')
    ax.plot_date( Time,SlowMA, 'k-' , linewidth=1 ,color='#00FF00')
        ...
        if ChangeKFlag==1:
            ...
            if len(SlowMA)>=SlowPeriod+2:
                ...
                if b != 0 :
                    ...
                    r,b,rr,topProfit,reValues = stopByMA(Time,Price,0.5,-0.5,r,b,topProfit,note,reValues,FastMA,SlowMA)
