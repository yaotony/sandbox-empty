        ...
        if BS=='S' or BS=='Sell':
            for i in range(CoverQty):
                ...
                if TmpInterest != []:
                    ...
                    self.OpenInterestQty -=1
                    # 新增交易紀錄
                    self.TradeRecord.append(['Buy',TmpInterest[1],TmpInterest[2],TmpInterest[3],CoverTime,CoverPrice,CoverPrice-TmpInterest[3]])
            ...
            for i in range(CoverQty):
                ...
                if TmpInterest != []:
                    ...
                    self.OpenInterestQty +=1
                    # 新增交易紀錄
                    self.TradeRecord.append(['Sell',TmpInterest[1],TmpInterest[2],TmpInterest[3],CoverTime,CoverPrice,TmpInterest[3] - CoverPrice ])
